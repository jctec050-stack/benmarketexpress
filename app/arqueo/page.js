...
export default function ArqueoPage() {
  ...
  const totalAEntregarGs = displayData.totalEfectivoBruto - totalMonedasExtranjerasGs - displayData.fondoFijo
          ...
          <div className="w-full">
            <div className="bg-white rounded-lg shadow p-6 border-t-4 border-blue-500">
              ...
              <div className="mt-6 space-y-2 text-sm">
                ...
                {totalMonedasExtranjerasGs > 0 && (
                  <div className="flex justify-between text-red-500">
                    <span>- Moneda Extranjera:</span>
                    <span>-{formatCurrency(totalMonedasExtranjerasGs)}</span>
                  </div>
                )}
                <div className="flex justify-between text-red-500">
                    ...
                    <tr key={i} className="border-b border-gray-100">
                      <td className="py-1">
                        {e.categoria === 'Pago a Proveedor' && e.receptor && (
                          <span className="text-blue-600 mr-1 font-bold">{e.receptor} - </span>
                        )}
                        {e.categoria === 'Retiro de Fondos' && e.receptor && (
                          <span className="text-purple-600 mr-1 font-bold">{e.receptor} - </span>
                        )}
